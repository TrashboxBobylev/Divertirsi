...
const AndesiteInfection = {
    dictionary: {
        ...
        "kubejs:andesite_infected": {block: "minecraft:andesite", chance: 1.0, explode: false},
        "chipped:andesite": {block: "actuallyadditions:black_quartz_ore", chance: 1.0, explode: false},
